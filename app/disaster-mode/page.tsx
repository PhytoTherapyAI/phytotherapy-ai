...
const tx: Record<string, { en: string; tr: string }> = {
  ...
  subtitle: { en: "Emergency health guide - designed for crisis situations", tr: "Acil saglik rehberi - kriz durumlari için tasarlandi" },
  ...
  loginForMeds: { en: "Log in to see your medications", tr: "İlaçlarinizi gormek için giris yapin" },
