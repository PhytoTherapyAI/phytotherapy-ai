...
const tx: Record<string, { en: string; tr: string }> = {
  ...
  subtitle: { en: "Emergency health guide - designed for crisis situations", tr: "Acil saglik rehberi - kriz durumlari icin tasarlandi" },
  emergencyCard: { en: "Emergency ID Card", tr: "Acil Durum Kimlik Karti" },
  myMeds: { en: "My Medications", tr: "Ilaclarim" },
  noMeds: { en: "No medications on file", tr: "Kayitli ilac yok" },
  loginForMeds: { en: "Log in to see your medications", tr: "Ilaclarinizi gormek icin giris yapin" },
  bloodType: { en: "Blood Type", tr: "Kan Grubu" },
  allergies: { en: "Allergies", tr: "Alerjiler" },
  none: { en: "None recorded", tr: "Kayit yok" },
  emergencyNumbers: { en: "Emergency Numbers", tr: "Acil Numaralar" },
  waterSafety: { en: "Water Safety", tr: "Su Guvenligi" },
...
const SECTIONS: Section[] = [
  {
    ...
    content: {
      ...
      tr: [
        ...
        "Icmeden once suyu en az 1 dakika kaynatin (yuksek rakimda 3 dakika).",
        ...
        "Minimum su ihtiyaci: hayatta kalma icin kisi basina gunluk 2 litre.",
        "Suyu temiz, kapali kaplarda saklayin. Tarih yazin.",
      ],
    },
  },
  {
    ...
    content: {
      ...
      tr: [
        "KANAMA: Temiz bezle dogrudan basinc uygulayin. Mumkunse yarayi kalp seviyesinin uzerine kaldirin.",
        ...
        "NEFES DURDU: Basi arkaya egin, ceneyi kaldirin, 2 kurtarma nefesi verin, 30 gogus basisi. Tekrarlayin.",
      ],
    },
  },
  {
    ...
    content: {
      ...
      tr: [
        ...
        "Basinc aniden kaldirildiginda ezilme sendromu olumcul kalp ritmi sorunlarina yol acabilir.",
        "Hemen profesyonel kurtarma ekiplerini cairin - IV sivilari ve protokolu bilirler.",
        "Birini kurtarmaniz gerekiyorsa: mumkunse basinci kaldirmadan ONCE su/oral sivi verin.",
  ...
  },
  {
    ...
    content: {
      ...
      tr: [
        "Afet sonrasi korku, kaygi ve kafasi karisiklik hissetmek NORMALDIR. Zayif degilsiniz.",
        "Yasadiklarinizi guvendiginiz birine anlatin. Kendinizi izole etmeyin.",
        "Rutinleri mumkun oldugunca surdurmeye calisin: duzenli ogunler, uyku, fiziksel aktivite.",
        "Afet haberleri ve sosyal medyaya maruziyeti sinirlayin. Guncellemeleri gunde sadece 2 kez kontrol edin.",
        ...
        "Cocuklar travmayi oyun, cizim veya davranis degisiklikleriyle ifade edebilir. Sabir ve mevcudiyet.",
      ],
    },
  },
  {
    ...
    content: {
      ...
      tr: [
        ...
        "Sarsinti duruncaya kadar icerde kalin. Cogu yaralanma sarsinti sirasinda hareket etmekten olur.",
        "Sarsinti sonrasi: gaz kacagini kontrol edin (koku), guvenliyse gazi kapatin. Asansor KULLANMAYIN.",
        ...
        "Sikisissaniz: kurtaricilara sinyal gondermek icin borulara veya duvarlara vurun.",
      ],
    },
  },
  {
    ...
    content: {
      ...
      tr: [
        "DERHAL yuksek yerlere cikin. Resmi uyarilari beklemeyin.",
        "15cm akan su sizi devirebilir. 60cm su bir arabayi surukler. ASLA sel suyunda yurumein veya surmeyin.",
        "Guvenliyse elektrigi kesin. Islaksa elektrikli ekipmanlara dokunmayin.",
        ...
        "Kuf 24-48 saat icinde olusur. Guvenli olur olmaz pencereleri acin ve kurutmaya baslayin.",
      ],
    },
  },
]
...
const EMERGENCY_NUMBERS = [
  { name: { en: "Emergency (Turkey)", tr: "Acil Yardim (Turkiye)" }, number: "112", color: "bg-red-500" },
