...
const ALL_PAGES = [
  ...
  "/pain-diary", "/elder-care", "/child-health",
  "/sports-performance", "/voice-diary", "/caffeine-tracker",
  "/alcohol-tracker", "/smoking-cessation",
  ...
  "/cardiovascular-risk", "/lung-monitor",
  "/pregnancy-tracker", "/postpartum-support",
  ...
  "/health-forum", "/health-challenges", "/support-groups",
  "/insurance-guide", "/medical-records",
  "/emergency-id", "/health-spending", "/wearable-hub", "/proactive-ai",
  "/ar-scanner", "/clinical-trials", "/second-opinion", "/cross-allergy",
  "/detox-facts", "/anti-inflammatory", "/hydration",
  "/circadian-rhythm",
  "/rare-diseases", "/donation",
