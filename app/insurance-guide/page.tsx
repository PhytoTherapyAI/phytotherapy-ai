...
const SECTIONS: AccordionSection[] = [
  {
    ...
    contentTr: [
      ...
      "Acil servis ziyaretleri hastane turune bakilmaksizin her zaman kapsanir.",
  ...
  },
  {
    ...
    contentTr: [
      ...
      "Mevcut hastaliklar: genellikle 1-2 yil haric tutulur.",
      ...
      "Planlari sigortam.net veya sigortaladim.com'da karsilastirin.",
    ],
  },
  {
    id: "medications",
    ...
    contentTr: [
      "Jenerik ilaclar marka ilaclardan daha dusuk katilim payina sahiptir.",
