...
const DRUG_DATABASE: DrugEntry[] = [
  ...
  { brand: "Lyrica", generic: "Pregabalin", category: { en: "Nerve Pain", tr: "Sinir Ağrısi" }, brandPrice: 210, genericPrice: 68, sgkCovered: true, genericBrands: ["Pregabin", "Preganox"], strength: "75mg" },
  ...
  { brand: "Parol", generic: "Acetaminophen", category: { en: "Pain Relief", tr: "Ağrı Kesici" }, brandPrice: 32, genericPrice: 15, sgkCovered: false, genericBrands: ["Minoset", "Tamol"], strength: "500mg" },
...
const tx: Record<string, { en: string; tr: string }> = {
  ...
  disclaimer: { en: "Always consult your doctor before switching medications. Generic equivalents contain the same active ingredient but may differ in inactive ingredients.", tr: "İlaç degistirmeden once mutlaka doktorunuza danisin. Jenerik esdegerler ayni etken maddeyi icerir ancak yardımcı maddeler farklılik gosterebilir." },
