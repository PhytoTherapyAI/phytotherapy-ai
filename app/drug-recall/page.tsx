...
const RECALL_DATABASE: RecallEntry[] = [
  { id: "r1", drugName: "Losartan Potassium", genericName: "losartan", reason: { en: "NDEA impurity above acceptable limit", tr: "NDEA safsizligi kabul edilebilir sinirin uzerinde" }, date: "2026-03-15", severity: "critical", action: { en: "Stop taking immediately, consult doctor for alternative", tr: "Hemen kullanmayi bırakın, alternatif için doktorunuza danışın" }, source: "FDA" },
  { id: "r2", drugName: "Metformin HCl ER", genericName: "metformin", reason: { en: "NDMA levels exceed acceptable daily intake", tr: "NDMA seviyeleri kabul edilebilir gunluk alimi asiyor" }, date: "2026-03-10", severity: "critical", action: { en: "Contact pharmacist for non-extended-release alternative", tr: "Uzatilmis salimli olmayan alternatif için eczaciniza danışın" }, source: "FDA", lot: "LOT-2026-0312" },
