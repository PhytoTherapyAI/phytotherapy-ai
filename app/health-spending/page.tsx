      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 bg-emerald-50 dark:bg-emerald-900/10 rounded-2xl border border-emerald-200 dark:border-emerald-800 p-6">
          ...
          <p className="text-sm text-emerald-700 dark:text-emerald-300">
            {lang === "tr"
              ? "Turkiye'de saglik harcamalari yillik gelir vergisi beyannamesinde indirim olarak gosterilebilir. SGK katilim paylari, ilac, ozel hastane, dis ve goz masraflari icin fatura ve makbuzlarinizi saklayin. Yillik toplam gelirin %10'unu gecmeyen saglik harcamalari indirilebilir."
