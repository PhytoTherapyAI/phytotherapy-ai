...
const FALLBACK_DATA: SemanticSearchResult[] = [
  ...
  { contentType: "condition", contentId: "dyspepsia", title: "Dyspepsia (Indigestion)", titleTr: "Dispepsi (Hazımsızlık)", description: "Gut health, nutrition, supplements", descriptionTr: "Bağırsak sağlığı, beslenme, takviyeler", href: "/health-assistant", category: "digestive", metadata: { symptoms: ["mide yanması", "heartburn", "indigestion", "hazımsızlık", "dispepsi", "bloating", "şişkinlik", "gastrit", "reflü", "reflux", "mide ağrısı"] }, similarity: 0, isAiMatch: false },
  { contentType: "condition", contentId: "migraine", title: "Migraine", titleTr: "Migren", description: "Trigger diary, attack tracking, prevention", descriptionTr: "Tetikleyici günlüğü, atak takibi, önleme", href: "/health-assistant", category: "neurological", metadata: { symptoms: ["migraine", "migren", "headache", "baş ağrısı", "aura", "bulantı", "nausea", "light sensitivity"] }, similarity: 0, isAiMatch: false },
]
