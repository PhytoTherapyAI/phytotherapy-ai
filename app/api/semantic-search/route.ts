...
const FALLBACK_DATA: SemanticSearchResult[] = [
  ...
  { contentType: "condition", contentId: "anxiety", title: "Anxiety Disorders", titleTr: "Anksiyete Bozuklukları", description: "GAD-7 screening, toolkit, breathing exercises", descriptionTr: "GAD-7 tarama, araç seti, nefes egzersizleri", href: "/anxiety-toolkit", category: "mental", metadata: { symptoms: ["anxiety", "anksiyete", "endişe", "panik", "gerginlik", "stress", "stres"] }, similarity: 0, isAiMatch: false },
  { contentType: "condition", contentId: "depression", title: "Depression", titleTr: "Depresyon", description: "PHQ-9 screening, mood tracking", descriptionTr: "PHQ-9 tarama, ruh hali takibi", href: "/depression-screening", category: "mental", metadata: { symptoms: ["depression", "depresyon", "sad", "üzgün", "mutsuz", "umutsuz", "hopeless", "mood"] }, similarity: 0, isAiMatch: false },
