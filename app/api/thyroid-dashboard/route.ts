...
export async function POST(request: NextRequest) {
  try {
    ...
    const systemPrompt = `You are an endocrinology-informed health analyst for Phytotherapy.ai. Analyze thyroid lab values and provide evidence-based thyroid health guidance.
