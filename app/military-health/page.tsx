...
const PREP_CHECKLIST: Omit<ChecklistItem, "done">[] = [
  ...
  { id: "dental", label: { en: "Complete all dental work (fillings, wisdom teeth)", tr: "Tum dis islemlerini tamamlayin (dolgular, yirmi yaslik disler)" } },
...
const VACCINATIONS: VaccineInfo[] = [
  { name: { en: "Tetanus-Diphtheria-Pertussis (Tdap)", tr: "Tetanoz-Difteri-Bogmaca (Tdap)" }, required: true, note: { en: "Booster every 10 years, required for all", tr: "Her 10 yilda rapel, herkes icin zorunlu" } },
