...
const AQI_LEVELS: AQILevel[] = [
  ...
  },
  {
    ...
    exercise: { en: "Moderate outdoor exercise OK. Sensitive groups reduce prolonged exertion.", tr: "Orta düzeyde dis mekan egzersizi uygun. Hassas gruplar uzun sureli efor azaltsin." },
  ...
  },
  {
    ...
    sensitive: { en: "Asthma/COPD: reduce outdoor time. Use preventive inhaler before going out.", tr: "Astim/KOAH: dis mekan suresini azaltin. Dışarı cikmadan once koruyucu inhaler kullanin." },
  ...
  {
    range: "151-200",
    label: { en: "Unhealthy", tr: "Sağlıksiz" },
  ...
  {
    range: "201-300",
    label: { en: "Very Unhealthy", tr: "Çok Sağlıksız" },
    ...
    sensitive: { en: "Asthma/COPD: do NOT go outside. Keep windows sealed. Run air purifier on max.", tr: "Astim/KOAH: dışarı ÇIKMAYIN. Pencereleri kapali tutun. Hava temizleyiciyi maksimumda çalıştırin." },
