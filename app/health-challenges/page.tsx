...
const CHALLENGES: Challenge[] = [
  {
    ...
    titleTr: "30 Gunluk Su Challenge'i",
    ...
    rulesTr: [
      "Gunluk en az 8 bardak (2 litre) su icin",
  ...
  },
  {
    ...
    titleTr: "21 Gunluk Sekersiz Yasam",
