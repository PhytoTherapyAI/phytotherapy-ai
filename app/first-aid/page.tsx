...
const SECTIONS: FirstAidSection[] = [
  ...
  },
  {
    ...
    stepsTr: [
      ...
      "Karna hizli, yukari dogru basklar yapin.",
      "Nesne cikana veya kisi bilincini kaybedene kadar tekrarlayin.",
      "Bilinc kaybederse, yere yatirin ve KPR'ye baslayin.",
    ],
  },
  {
    id: "choking-child",
    ...
    stepsTr: [
      ...
      "Bebegi yuz uste cevirin. Gogus kemiqi uzerine 2 parmakla 5 gogus basisi yapin.",
      "Nesne cikana kadar sirt darbeleri ve gogus basilarini degisimli yapin.",
      "1 yas ustu cocuklar icin: Yetiskinlerdeki gibi Heimlich manevrasi uygulayin.",
      "Cocuk bilincini kaybederse hemen KPR'ye baslayin.",
      "Henuz aranmadiysa 112'yi arayin.",
    ],
  },
  {
    id: "burns",
    ...
    stepsTr: [
      ...
      "Avuc icinden buyuk, yuz/el/eklem bolgesinde veya derin yaniklar icin tibbi yardim alin.",
    ],
  },
  {
    id: "bleeding",
    ...
    stepsTr: [
      "Siddetli kanama icin 112'yi arayin.",
      "Temiz bir bez veya bandajla yaraya dogrudan baski uygulayin.",
    ...
    warningTr: "10 dakika dogrudan baski sonrasi durmayan her kanama icin acil tibbi yardim alin.",
  },
  {
    id: "poisoning",
    ...
    stepsTr: [
      "Hemen 112 veya Zehir Danisma Merkezini (114) arayin.",
      "Zehiri tanimlamayin calsin (mumkunse kutu/etiketi saklayin).",
      "Tip profesyoneli soylemedikce KUSTURMAYIN.",
      "Kisi bilincini kaybettiyse iyilesme (yan yatis) pozisyonuna getirin.",
    ...
    warningTr: "Asla zehiri notralise etmeye calismayin (ornegin alkaliye asit vermek). Profesyonellere birakin.",
  },
  {
    id: "snakebite",
    ...
    stepsTr: [
      "Yilandan uzaklasin. Yakalamaya veya oldurmeye calismayin.",
      "Hemen 112'yi arayin.",
      "Isirilan uzvu hareketsiz tutun ve kalp seviyesinin altinda tutun.",
      "Isirma yakinindaki saat, yuzuk veya dar giysileri cikarin.",
      "Yarayi KESMEYIN, zehiri emmeye calismayin, turnike UYGULAMAYIN.",
      "Buz UYGULAMAYIN veya soguk suya BATIRMAYIN.",
      "Isirma zamanini ve mumkunse yilanin gorunumunu not edin.",
      "Zehirin yayilmasini yavaslatmak icin sakin ve hareketsiz kalin.",
    ],
  },
  {
    id: "anaphylaxis",
    ...
    stepsTr: [
      "Hemen 112'yi arayin. Bu hayati tehlike arz eden bir acil durumdur.",
    ...
    warningTr: "Anafilaksi dakikalar icinde olumcul olabilir. Iyilesip iyilesmeyecegini beklemeyin — hemen 112'yi arayin ve EpiPen kullanin.",
  },
  {
    id: "fractures",
    ...
    stepsTr: [
      "Yarali uzvu hareket ettirmeyin veya duzeltmeye calismayin.",
      "Omurga, kalca veya pelvis kirigi supheleniyorsaniz 112'yi arayin.",
      "Yarayi atel ile sabitleyin (tahta, dergi veya sarili giysi kullanin).",
      "Sismeyi azaltmak icin beze sarilmis buz uygulayin (20 dakika acik, 20 kapali).",
      ...
      "Sok icin onlem alin: sicak tutun, bacaklar yukarda (omurga yaralanmasi yoksa).",
    ],
  },
  {
    id: "drowning",
    ...
    stepsTr: [
      "112'yi arayin. Su kurtarma egitimli degilseniz suya GIRMEYIN.",
      "Yuzen bir cisim, ip veya yuzebilecek herhangi bir sey atin.",
      "Karaya cikarinca solunumu kontrol edin.",
      "Nefes almiyorsa hemen KPR'ye baslayin. 5 kurtarma nefesiyle baslayin, sonra 30:2.",
      "Nefes aliyorsa ama bilinci yoksa iyilesme pozisyonuna getirin.",
