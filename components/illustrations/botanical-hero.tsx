...
export function BotanicalHero({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <g opacity="0.08">
        <ellipse cx="200" cy="280" rx="160" ry="200" fill="var(--brand, #3c7a52)" />
      </g>

      {/* Main stem */}
      <path
        d="M200 480 C200 380, 195 300, 200 180"
        stroke="var(--brand, #3c7a52)"
        strokeWidth="3"
        strokeLinecap="round"
        fill="none"
      />
      ...
      <circle cx="80" cy="200" r="4" fill="var(--brand, #3c7a52)" opacity="0.25" />
      <circle cx="95" cy="185" r="3" fill="var(--brand, #3c7a52)" opacity="0.2" />
      <line x1="80" y1="200" x2="95" y2="185" stroke="var(--brand, #3c7a52)" strokeWidth="1" opacity="0.15" />
      ...
      <circle cx="310" cy="380" r="3.5" fill="var(--brand, #3c7a52)" opacity="0.2" />
      <circle cx="328" cy="370" r="2.5" fill="var(--brand, #3c7a52)" opacity="0.15" />
      <line x1="310" y1="380" x2="328" y2="370" stroke="var(--brand, #3c7a52)" strokeWidth="1" opacity="0.12" />
      ...
      <g opacity="0.12" transform="translate(330, 130)">
        <rect x="-2" y="-8" width="4" height="16" rx="1" fill="var(--brand, #3c7a52)" />
        <rect x="-8" y="-2" width="16" height="4" rx="1" fill="var(--brand, #3c7a52)" />
      </g>

      {/* Medical cross — subtle bottom-left */}
      <g opacity="0.1" transform="translate(60, 440)">
        <rect x="-1.5" y="-6" width="3" height="12" rx="1" fill="var(--brand, #3c7a52)" />
        <rect x="-6" y="-1.5" width="12" height="3" rx="1" fill="var(--brand, #3c7a52)" />
      </g>
    </svg>
  );
}
