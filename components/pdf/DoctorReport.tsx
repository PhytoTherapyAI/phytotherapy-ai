...
// falling back to Helvetica transliteration. Fonts live in public/fonts; resolved via
// filesystem because this component renders server-side in /api/generate-pdf.
Font.register({
  family: "NotoSans",
  fonts: [
