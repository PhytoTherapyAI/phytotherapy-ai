...
export function RadiologyReport({ analysis, lang = "en" }: RadiologyReportProps) {
  ...
  const t = {
    ...
    subtitle: lang === "tr"
      ? "Eğitim Amaçlı Radyolojik Görüntü Yorumu | Sağlık Profesyoneli İncelemesi İçin"
      : "Educational Radiology Image Interpretation | For Healthcare Provider Review",
    findings: lang === "tr" ? "Bulgular" : "Findings",
    glossary: lang === "tr" ? "Tıbbi Terimler Sözlüğü" : "Medical Glossary",
    doctor: lang === "tr" ? "Doktorunuzla Konuşun" : "Discussion Points for Your Doctor",
    limitations: lang === "tr" ? "Analiz Sınırları" : "Analysis Limitations",
    disclaimer: lang === "tr" ? "ÖNEMLİ UYARI" : "IMPORTANT DISCLAIMER",
    urgency: lang === "tr" ? "Aciliyet" : "Urgency",
    modality: lang === "tr" ? "Modalite" : "Modality",
    medicalTerm: lang === "tr" ? "Tıbbi terim" : "Medical term",
    defaultDisclaimer: lang === "tr"
      ? "Bu rapor DoctoPal tarafından eğitim amaçlı oluşturulmuştur. Radyolojik tanı DEĞİLDİR. Tüm tıbbi görüntüler nitelikli bir radyolog tarafından yorumlanmalıdır. Daima sağlık profesyoneline danışın."
      ...
      <Page size="A4" style={styles.page}>
        ...
        {analysis.findings.map((f, i) => (
          <View key={i} style={styles.finding}>
            ...
            <Text style={styles.findingText}>{t.medicalTerm}: {f.medicalTerm}</Text>
