    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.disclaimer}>
          <Text style={{ fontFamily: "NotoSans", fontWeight: "bold", marginBottom: 4 }}>IMPORTANT DISCLAIMER</Text>
          <Text>{analysis.disclaimer || "This report is generated by DoctoPal for educational purposes only. It is NOT a radiological diagnosis. A qualified radiologist must interpret all medical images. Always consult your healthcare provider."}</Text>
        </View>

        <View style={styles.footer}>
          <Text>Generated by DoctoPal | doctopal.com</Text>
          <Text>{date}</Text>
        </View>
      </Page>
    </Document>
