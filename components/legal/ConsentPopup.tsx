...
const CONSENT_TEXTS: Record<ConsentType, { tr: ConsentText; en: ConsentText }> = {
  consent_ai_processing: {
    ...
    en: {
      ...
      details: [
        ...
        "AI providers: Anthropic Claude (USA) — text and multimodal analysis",
        "Identity information (name, email, ID) is removed before sending to AI (anonymization)",
        "Consent version: v2.0 (April 2026)",
      ],
  ...
  consent_data_transfer: {
    tr: {
      ...
      details: [
        "Veri depolama: Supabase (İrlanda / AB) — hukuki dayanak açık rıza (KVKK Md.9/1)",
        "AI analizi: Anthropic Claude (ABD) — anonimleştirilmiş sağlık verisi ve görsel dosyalarla",
        "Semantic arama: Google Gemini text-embedding-004 (ABD) — kimlik içermeyen arama metinleri",
        "Aktarılan veri kategorisi: sağlık verisi (ilaç, alerji, hastalık, semptom) + görsel dosyalar (kan tahlili, radyoloji)",
        "Hukuki dayanak: KVKK Md.9 + Md.6 (yurt dışı aktarım için açık rıza)",
        "ABD ve AB'de kişisel veri koruma standartları (GDPR, CCPA) uygulanmaktadır",
        "SCC (Standart Sözleşme) imzalama süreci şirket tescili sonrası tamamlanacaktır",
        "Rıza versiyon: v2.0 (Nisan 2026)",
      ],
      warning: "Bu rızayı vermezseniz AI özellikleri ve semantic arama kullanılamaz çünkü hizmet sağlayıcılarımız ABD/AB'dedir. İlaç takibi, takvim, aile profili gibi temel özellikler etkilenmez.",
      acceptButton: "Okudum, açık rıza veriyorum",
      cancelButton: "Vazgeç",
    },
    en: {
      ...
      details: [
        "Data storage: Supabase (Ireland / EU) — legal basis: explicit consent (KVKK Art.9/1)",
        "AI analysis: Anthropic Claude (USA) — with anonymized health data and visual files",
        "Semantic search: Google Gemini text-embedding-004 (USA) — search text without identity data",
        "Data categories transferred: health data (medications, allergies, conditions, symptoms) + visual files (blood tests, radiology)",
        "Legal basis: KVKK Art.9 + Art.6 (explicit consent for international transfer)",
        "USA and EU apply personal data protection standards (GDPR, CCPA)",
        "SCC (Standard Contractual Clauses) signing will be completed after company registration",
        "Consent version: v2.0 (April 2026)",
      ],
      warning: "Without this consent, AI features and semantic search cannot be used as our providers are in the USA/EU. Basic features like medication tracking, calendar, family profiles are unaffected.",
      acceptButton: "I have read and give explicit consent",
      cancelButton: "Cancel",
    },
  },
