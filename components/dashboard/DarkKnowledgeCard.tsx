...
const KNOWLEDGE_FACTS: KnowledgeFact[] = [
  // ── Medication-specific facts ──
  {
    ...
    tr: "Metformin zamanla B12 seviyenizi dusürebilir. Yillik B12 testi icin doktorunuza danisın.",
  ...
  },
  {
    ...
    tr: "Diyabet ilaci kullaniyorsanız ayaklarinizi gunluk kesik veya yara icin kontrol edin.",
    link: "/diabetic-foot",
    type: "medication",
  },
  {
  ...
  },
  {
    ...
    tr: "Bagirsak mikrobiyomunuz icin haftada 30+ farkli bitkisel gida tuketin. Cesitlilik miktardan onemlidir.",
    link: "/gut-health",
    type: "general",
  },
  {
