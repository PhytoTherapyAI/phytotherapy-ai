...
export const CONSENT_TEXT = {
  en: {
    ...
    body: "By connecting this service, you authorize Phytotherapy.ai to access the following health data from your account. This data will be used solely to provide personalized health recommendations.",
  ...
  tr: {
    ...
    body: "Bu hizmeti bağlayarak, Phytotherapy.ai'nin hesabınızdan aşağıdaki sağlık verilerine erişmesine izin verirsiniz. Bu veriler yalnızca kişiselleştirilmiş sağlık önerileri sunmak için kullanılacaktır.",
