...
export const TOOL_CATEGORIES: ToolCategory[] = [
  ...
  // ── 3. Supplements & Natural ────────────
  {
    ...
    modules: [
      ...
      { id: "drug-equivalent", title: { en: "Drug Equivalent", tr: "İlaç Muadili" }, icon: "ArrowRightLeft", href: "/drug-equivalent" },
  ...
  // ── 10. Tracking & Diaries ──────────────
  {
    ...
    modules: [
      ...
      { id: "friend-goals", title: { en: "Friend Goals", tr: "Arkadaş Hedefleri" }, icon: "Users", href: "/friend-goals" },
      { id: "time-capsule", title: { en: "Time Capsule", tr: "Zaman Kapsülü" }, icon: "Clock", href: "/time-capsule" },
      { id: "weekly-newsletter", title: { en: "Weekly Summary", tr: "Haftalık Bülten" }, icon: "Mail", href: "/weekly-newsletter" },
    ],
  },
  ...
  // ── 12. Medical Tools & Emergency ───────
  {
    ...
    modules: [
      ...
      { id: "drug-recall", title: { en: "Drug Recalls", tr: "İlaç Geri Çağırma" }, icon: "AlertOctagon", href: "/drug-recall" },
      { id: "medication-buddy", title: { en: "Med Buddy", tr: "İlaç Arkadaşı" }, icon: "Users", href: "/medication-buddy" },
      { id: "health-report-card", title: { en: "Health Report Card", tr: "Sağlık Karnesi" }, icon: "FileText", href: "/health-report-card" },
    ],
  },
  ...
  // ── 13. Life Stages & Special ───────────
  {
    ...
    modules: [
      ...
      { id: "disaster-mode", title: { en: "Disaster Mode", tr: "Afet Modu" }, icon: "AlertOctagon", href: "/disaster-mode" },
      { id: "interests", title: { en: "Interests Setup", tr: "İlgi Alanları" }, icon: "Sparkles", href: "/interests" },
    ],
  },
  ...
  // ── 14. Community & Learning ────────────
  {
    ...
    modules: [
      ...
      { id: "talent-hub", title: { en: "Talent Hub", tr: "Yetenek Ağı" }, icon: "Users", href: "/talent-hub" },
    ],
  },
  ...
  // ── 15. Harvard HVHS & Advanced ─────────
  {
    ...
    description: { en: "Global benchmarking, care pathways, research hub & FHIR", tr: "Küresel kıyaslama, bakım yolları, araştırma hub'ı ve FHIR" },
    defaultModule: "global-benchmark",
    layout: "grid",
    modules: [
      { id: "global-benchmark", title: { en: "Global Benchmark", tr: "Küresel Kıyaslama" }, icon: "Globe", href: "/global-benchmark" },
      { id: "health-roadmap", title: { en: "Health Roadmap", tr: "Sağlık Yol Haritası" }, icon: "Map", href: "/health-roadmap" },
      { id: "research-hub", title: { en: "Research Hub", tr: "Araştırma Hub'ı" }, icon: "FlaskConical", href: "/research-hub" },
      { id: "share-data", title: { en: "Share Data (FHIR)", tr: "Veri Paylaş (FHIR)" }, icon: "Share2", href: "/share-data" },
      { id: "creator-studio", title: { en: "Creator Studio", tr: "İçerik Stüdyosu" }, icon: "PenTool", href: "/creator-studio" },
    ],
  },
  ...
  // ── 16. Settings & Account ──────────────
  {
    ...
    description: { en: "Notifications, privacy, devices, data management", tr: "Bildirimler, gizlilik, cihazlar, veri yönetimi" },
    ...
    modules: [
      ...
      { id: "bug-report", title: { en: "Report Bug", tr: "Hata Bildir" }, icon: "Bug", href: "/bug-report" },
      { id: "certificates", title: { en: "Certificates", tr: "Sertifikalar" }, icon: "Award", href: "/certificates" },
