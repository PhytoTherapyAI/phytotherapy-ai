...
export const PATENT_FILINGS: PatentFiling[] = [
  ...
  { id: "PAT-003", title: "Berberine-Cyclodextrin Inclusion Complex for Oral Delivery", titleTr: "Oral Uygulama icin Berberin-Siklodekstrin Inkluzyon Kompleksi", company: "Sabinsa Corp.", filingDate: "2025-12-08", status: "Under Review", jurisdiction: "EPO", botanical: "Berberine" },
  ...
  { id: "PAT-009", title: "Nanoparticle-Based Curcumin for Blood-Brain Barrier Penetration", titleTr: "Kan-Beyin Bariyeri Gecisi icin Nanopartikul Bazli Kurkumin", company: "Verdure Sciences", filingDate: "2026-03-05", status: "Filed", jurisdiction: "USPTO", botanical: "Curcumin" },
  ...
  { id: "PAT-011", title: "Synergistic Berberine-Silymarin Formulation for Metabolic Health", titleTr: "Metabolik Saglik icin Sinerjistik Berberin-Silimarin Formulasyonu", company: "Thorne Research", filingDate: "2025-11-05", status: "Under Review", jurisdiction: "USPTO", botanical: "Berberine" },
...
export const REGULATORY_UPDATES: RegulatoryUpdate[] = [
  {
    ...
    summaryTr: "FDA, N-Asetil Sistein'in takviye olarak pazarlanabilecegini acikladi ve onceki tutumunu degistirdi. Takviye endustrisi icin buyuk kazanim.",
  },
  {
    id: "REG-002",
    title: "EMA Approves New Curcumin Health Claim Application",
    titleTr: "EMA Yeni Kurkumin Saglik Beyani Basvurusunu Onayladi",
    agency: "EMA",
    type: "Health Claim",
    date: "2026-02-28",
    status: "Approved",
    ...
    summaryTr: "Avrupa Ilac Ajansi, kurkuminin normal eklem fonksiyonuna katkisina iliskin Madde 13.1 saglik beyanini onayladi.",
  },
  {
    id: "REG-003",
    title: "EFSA Re-evaluates Ashwagandha Novel Food Status",
    titleTr: "EFSA Ashwagandha Novel Food Statusunu Yeniden Degerlendiriyor",
    agency: "EFSA",
    type: "Novel Food",
    date: "2026-03-01",
    status: "Under Review",
    ...
    summaryTr: "EFSA paneli, gunluk 600mg ustu dozlarda ashwagandha kok ekstraktinin guvenligini inceliyor. Danimarka ve Italya kisitlama onerdi.",
  },
  {
    id: "REG-004",
    ...
    summaryTr: "FDA, grip mevsiminde muzver ve kuersetin urunleri icin onaylanmamis hastalik beyanlari yapan sirketlere yaptrim uyguladi.",
  },
  {
    id: "REG-005",
    title: "TGA Updates Complementary Medicine Framework",
    titleTr: "TGA Tamamlayici Tip Cercevesini Guncelledi",
    agency: "TGA",
    ...
    summaryTr: "Avustralya TGA, geleneksel bitkisel ilaclar icin listelenmis ilac yolunu basitlestirdi.",
  },
  {
    id: "REG-006",
    title: "EFSA Positive Opinion on Berberine Safety Assessment",
    titleTr: "EFSA Berberin Guvenlik Degerlendirmesi Olumlu Gorus",
    agency: "EFSA",
    ...
    summaryTr: "EFSA, Berberis vulgaris'ten gunluk 500mg berberinin hamileler haric yetiskinler icin guvenli oldugu sonucuna vardi.",
  },
  {
    id: "REG-007",
    title: "FDA Accepts GRAS Notification for Lion's Mane Extract",
    titleTr: "FDA Aslan Yelesi Ekstrakti icin GRAS Bildirimini Kabul Etti",
    agency: "FDA",
    type: "GRAS Notice",
    date: "2026-03-10",
    status: "Approved",
    ...
    summaryTr: "Aslan Yelesi meyveli govde ekstrakti, fonksiyonel gidalarda kullanim icin FDA GRAS statusu aldi.",
  },
  {
    id: "REG-008",
    title: "EMA Initiates Herbal Monograph Review for Rhodiola",
    titleTr: "EMA Rhodiola icin Bitkisel Monograf Incelemesi Baslatti",
    agency: "EMA",
    ...
    summaryTr: "EMA Bitkisel Ilac Komitesi, Rhodiola rosea topluluk bitkisel monografini guncellemeye basladi.",
  },
  {
    id: "REG-009",
    title: "FDA Proposes Mandatory Product Listing for Supplements",
    titleTr: "FDA Takviyeler icin Zorunlu Urun Listeleme Onerisi",
    agency: "FDA",
    type: "Proposed Rule",
    date: "2026-02-20",
    status: "Pending",
    ...
    summaryTr: "Onerilen kural, tum takviye ureticilerinin urunlerini FDA'ya kaydetmesini zorunlu kilarak seffafligi artiracak.",
  },
  {
    id: "REG-010",
    ...
    summaryTr: "EFSA NDA Paneli, Madde 13.5 saglik beyani basvurusu icin kuersetin fitozom biyoyararlanimi hakkindaki yeni kanitlari degerlendiriyor.",
  },
];
...
export const SECTOR_EVENTS: SectorEvent[] = [
  { date: "2026-03-22", type: "Funding", company: "Gaia Herbs", detail: "Series C — $85M led by KKR for retail expansion", detailTr: "Seri C — perakende genisleme icin KKR liderliginde 85M$", valueBillions: 0.085 },
  ...
  { date: "2026-02-18", type: "IPO", company: "Layn Natural Ingredients", detail: "NASDAQ IPO at $14/share — $420M raised for monk fruit & stevia", detailTr: "NASDAQ halka arzi 14$/hisse — keciboynuzu & stevia icin 420M$ toplandi", valueBillions: 0.42 },
  { date: "2026-02-05", type: "Funding", company: "Nammex", detail: "Series B — $32M for mushroom extract R&D facilities", detailTr: "Seri B — mantar ekstrakt Ar-Ge tesisleri icin 32M$", valueBillions: 0.032 },
  ...
  { date: "2026-01-15", type: "Partnership", company: "Herbalife + Alibaba Health", detail: "Exclusive distribution deal for China market entry", detailTr: "Cin pazarina giris icin ozel dagitim anlasmasi" },
  { date: "2025-12-20", type: "Funding", company: "Metagenics", detail: "Private equity — $650M from Alticor for functional medicine platform", detailTr: "Ozel sermaye — fonksiyonel tip platformu icin Alticor'dan 650M$", valueBillions: 0.65 },
  ...
  { date: "2025-10-15", type: "Funding", company: "Host Defense (Fungi Perfecti)", detail: "Series A — $28M for medicinal mushroom clinical trials", detailTr: "Seri A — tibbi mantar klinik calismalari icin 28M$", valueBillions: 0.028 },
];
