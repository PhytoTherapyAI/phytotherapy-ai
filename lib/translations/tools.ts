...
export const toolsTranslations: Record<string, TranslationEntry> = {
  ...
  // F-INTERACTION-VISION-001: photo-scan flow inside the
  // interaction checker. Reuses the existing /api/scan-medication
  // endpoint + scan.error.noFrame above for the F-SCAN-SAFETY-002
  // 4-Layer Defense toasts. These keys cover the modal UI itself.
  "interaction.photoScan.openButton": { en: "Add by photo", tr: "Foto ile ekle" },
  "interaction.photoScan.title": { en: "Scan Medication", tr: "İlaç Tara" },
  "interaction.photoScan.close": { en: "Close", tr: "Kapat" },
  "interaction.photoScan.chooseDesc": { en: "Take a photo or pick from gallery to identify medication.", tr: "İlacı tanımak için fotoğraf çekin veya galeriden seçin." },
  "interaction.photoScan.useCamera": { en: "Use Camera", tr: "Kamera Aç" },
  "interaction.photoScan.useGallery": { en: "Pick from Gallery", tr: "Galeriden Seç" },
  "interaction.photoScan.capture": { en: "Capture", tr: "Çek" },
  "interaction.photoScan.analyze": { en: "Analyze", tr: "Analiz Et" },
  "interaction.photoScan.analyzing": { en: "Analyzing…", tr: "Analiz ediliyor…" },
  "interaction.photoScan.retake": { en: "Retake / Choose another", tr: "Yeniden çek / Başka seç" },
  ...
  "interaction.photoScan.cameraError": { en: "Could not access camera", tr: "Kameraya erişilemedi" },
  "interaction.photoScan.scanFailed": { en: "Could not identify medication", tr: "İlaç tanımlanamadı" },
  "interaction.photoScan.networkError": { en: "Network error — please try again", tr: "Ağ hatası — tekrar deneyin" },
  "interaction.photoScan.emptyName": { en: "Medication name cannot be empty", tr: "İlaç adı boş olamaz" },
