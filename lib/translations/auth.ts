...
export const authTranslations: Record<string, TranslationEntry> = {
  ...
  // Sprint 30 Commit 2 — Forgot password flow (login modal + reset-password page).
  "auth.forgotPassword": { en: "Forgot password?", tr: "Şifremi Unuttum?" },
  "auth.resetTitle": { en: "Password Reset", tr: "Şifre Sıfırlama" },
  "auth.resetDesc": { en: "Enter your email and we'll send you a reset link.", tr: "E-posta adresini gir, sana sıfırlama linki gönderelim." },
  "auth.resetSubmit": { en: "Send Reset Link", tr: "Şifre Sıfırlama Linki Gönder" },
  "auth.resetSubmitting": { en: "Sending...", tr: "Gönderiliyor..." },
  "auth.resetCancel": { en: "Cancel", tr: "İptal" },
  "auth.resetSent": { en: "Password reset link sent to your email.", tr: "Şifre sıfırlama linki e-postanıza gönderildi." },
  "auth.errResetFailed": { en: "Failed to send reset link. Please try again.", tr: "Sıfırlama linki gönderilemedi. Tekrar deneyin." },
  "auth.newPassword": { en: "New Password", tr: "Yeni Şifre" },
  "auth.confirmNewPassword": { en: "Confirm New Password", tr: "Yeni Şifre (Tekrar)" },
  "auth.updatePassword": { en: "Update Password", tr: "Şifreyi Güncelle" },
  "auth.updatingPassword": { en: "Updating...", tr: "Güncelleniyor..." },
  "auth.passwordUpdated": { en: "Password updated. You can sign in now.", tr: "Şifreniz güncellendi, giriş yapabilirsiniz." },
  "auth.resetTokenInvalid": { en: "Reset link is invalid or expired. Request a new one.", tr: "Sıfırlama linki geçersiz veya süresi dolmuş. Yeni bir link iste." },
  "auth.resetPageTitle": { en: "Set New Password", tr: "Yeni Şifre Belirle" },
  "auth.resetPageDesc": { en: "Choose a new password for your account.", tr: "Hesabın için yeni bir şifre belirle." },
