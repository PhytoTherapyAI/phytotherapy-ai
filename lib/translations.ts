...
const commonToolKeys: Record<string, TranslationEntry> = {
  ...
  "privacy.s6i2": { en: "Google Gemini API — AI analysis engine. Your health queries, medication list, and allergy information may be sent to generate personalized recommendations. No data is stored by Google beyond the request.", tr: "Google Gemini API — Yapay zeka analiz motoru. Kişiselleştirilmiş öneriler üretmek için sağlık sorularınız, ilaç listeniz ve alerji bilgileriniz gönderilebilir. Google tarafından istek dışında veri saklanmaz." },
