...
const commonToolKeys: Record<string, TranslationEntry> = {
  ...
  "enterprise.aiDesc": { en: "Gemini AI analyzes the latest botanical publication trends, company data and regulatory changes to generate investment-relevant signals.", tr: "Gemini AI, en son botanik yayin trendlerini, sirket verilerini ve regulasyon değişikliklerini analiz ederek yatirim sinyalleri uretir." },
  ...
  "privacy.s6i1": { en: "Database and authentication infrastructure", tr: "Veritabanı ve kimlik doğrulama altyapısı" },
  "privacy.s6i2": { en: "AI analysis engine (queries processed anonymously, no personal data transmitted)", tr: "Yapay zeka analiz motoru (sorgular anonim olarak işlenir, kişisel veri iletilmez)" },
  "privacy.s6i3": { en: "Scientific research databases (publicly available sources)", tr: "Bilimsel araştırma veritabanları (halka açık kaynaklar)" },
  "privacy.s6i4": { en: "Drug safety databases (publicly available sources)", tr: "İlaç güvenlik veritabanları (halka açık kaynaklar)" },
  "privacy.s6i5": { en: "Web hosting service", tr: "Web barındırma hizmeti" },
