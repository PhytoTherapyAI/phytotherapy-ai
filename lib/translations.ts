...
const t: Record<string, TranslationEntry> = {
  ...
  // Allergies Step
  "onb.allergySubtitle": { en: "Allergy (immune response) or intolerance (digestive/enzymatic issue) — you can add both.", tr: "Alerji (bağışıklık sistemi tepkisi) veya intolerans (sindirim/enzimatik sorun) — ikisini de ekleyebilirsin." },
  ...
  "onb.noAllergies": { en: "I have no known allergies or intolerances", tr: "Bilinen alerjim veya intoleransım yok" },
  ...
  "onb.stepBasicDesc": { en: "Tell us about yourself", tr: "Seni daha yakından tanıyalım" },
  "onb.stepMedsTitle": { en: "Current Medications", tr: "Mevcut İlaçlar" },
  "onb.stepMedsDesc": { en: "Active medications you take", tr: "Kullandığın aktif ilaçlar" },
  "onb.stepAllergiesTitle": { en: "Allergies & Sensitivities", tr: "Alerjiler ve Hassasiyetler" },
  "onb.stepAllergiesDesc": { en: "Allergies and intolerances", tr: "Alerji ve intoleransların" },
  ...
  "onb.stepSubstancesDesc": { en: "Substance use information", tr: "Madde kullanım bilgin" },
  "onb.stepMedicalTitle": { en: "Medical History", tr: "Tıbbi Geçmiş" },
  "onb.stepMedicalDesc": { en: "Key health conditions", tr: "Önemli sağlık durumların" },
  "onb.stepFamilyTitle": { en: "Family History", tr: "Soygeçmiş" },
  "onb.stepFamilyDesc": { en: "Health conditions in close family", tr: "Aile sağlık öyküsü" },
  "onb.stepPermissionsTitle": { en: "To Provide You With a Flawless Experience", tr: "Sana Kusursuz Bir Asistanlık Sunabilmemiz İçin" },
  "onb.stepPermissionsDesc": { en: "Some features will need your permission", tr: "Bazı özellikler için iznine ihtiyaç duyacağız" },
  "onb.stepConsentTitle": { en: "Terms & Consent", tr: "Şartlar & Onay" },
  "onb.stepConsentDesc": { en: "Medical disclaimer agreement", tr: "Tıbbi sorumluluk reddi" },
  ...
  "onb.suppSubtitle": { en: "Vitamins, minerals or herbal supplements — important for interaction checks", tr: "Vitamin, mineral veya bitkisel takviyeler — ilaçlarla etkileşim kontrolü için önemli" },
  ...
  "onb.suppNoSupplements": { en: "I don't take any supplements", tr: "Takviye kullanmıyorum" },
