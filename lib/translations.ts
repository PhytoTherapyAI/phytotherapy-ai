...
const t: Record<string, TranslationEntry> = {
  ...
  "onb.stepAydinlatmaTitle": { en: "Privacy Notice", tr: "Aydınlatma Metni" },
  "onb.stepAydinlatmaDesc": { en: "Before giving consent, please read how we process your data (KVKK Article 10).", tr: "Rıza vermeden önce, verilerinizi nasıl işlediğimizi okuyun (KVKK Madde 10)." },
  "onb.whyAydinlatma": { en: "KVKK requires us to inform you about data processing BEFORE asking for your consent. This is a separate step by law.", tr: "KVKK, rıza istemeden ÖNCE veri işleme hakkında sizi bilgilendirmemizi zorunlu kılar. Bu, kanunen ayrı bir adımdır." },
...
const commonToolKeys: Record<string, TranslationEntry> = {
  ...
  "profile.motiv.allergies": { en: "Without your allergy info I fly blind. Add it so I never recommend something harmful.", tr: "Alerji bilgin olmadan k\u00f6r u\u00e7uyorum. Ekle ki sana zarar verebilecek hi\u00e7bir \u015fey \u00f6nermeyelim." },
  "profile.motiv.medical": { en: "Chronic disease data triples my early warning power. Without it I give generic advice \u2014 you\u2019re not generic.", tr: "Kronik hastal\u0131k verin, erken uyar\u0131 g\u00fcc\u00fcm\u00fc 3 kat\u0131na \u00e7\u0131kar\u0131r. Bu bilgi olmadan genel \u00f6neriler veririm \u2014 sen genel de\u011filsin." },
  "profile.motiv.name": { en: "Your name lets me talk to you personally \u2014 not like a generic chatbot.", tr: "Ad\u0131n, sana ki\u015fisel hitap etmemi sa\u011flar \u2014 jenerik bir chatbot gibi de\u011fil." },
  "profile.motiv.lifestyle": { en: "Lifestyle info shapes supplement and dosage recommendations for your specific routine.", tr: "Ya\u015fam tarz\u0131 bilgisi, senin rutinine \u00f6zel takviye ve doz \u00f6nerilerini \u015fekillendirir." },
  "profile.motiv.body": { en: "Add height & weight and I\u2019ll calculate personalized BMI-based dosing. Without it I give standard doses.", tr: "Boy ve kilonu eklersen BMI tabanl\u0131 ki\u015fisel dozaj hesab\u0131 yapar\u0131m. Eklemezsen genel dozlar veririm." },
  "profile.motiv.blood": { en: "What does your blood type say about your health? Add it and discover your epidemiological risk tags.", tr: "Kan grubun sa\u011fl\u0131\u011f\u0131n hakk\u0131nda ne s\u00f6yl\u00fcyor? Ekle ve epidemiyolojik risk etiketlerini g\u00f6r." },
  ...
  "profile.motiv.almost": { en: "Almost there! Add the last few bits and your AI reaches full power \ud83d\ude80", tr: "Neredeyse tam! Son birka\u00e7 veriyi ekle ve AI asistan\u0131n tam g\u00fcce ula\u015fs\u0131n \ud83d\ude80" },
  "profile.motiv.good": { en: "Good progress \u2014 every added data makes your recommendations safer.", tr: "G\u00fczel gidiyorsun \u2014 her eklenen veri \u00f6nerilerimi daha g\u00fcvenli yap\u0131yor." },
  "profile.motiv.start": { en: "Complete your profile \u2014 you haven\u2019t seen DoctoPal\u2019s real power yet. First step is hardest, we\u2019ll handle the rest \ud83d\udcaa", tr: "Profili tamamla \u2014 DoctoPal\u2019\u0131n ger\u00e7ek g\u00fcc\u00fcn\u00fc hen\u00fcz g\u00f6rmedin. \u0130lk ad\u0131m en zoru, gerisini biz hallederiz \ud83d\udcaa" },
  "profile.motiv.complete": { en: "\ud83c\udf89 Your profile is complete! AI assistant running at full power. Now I can tell you what\u2019s right for YOU.", tr: "\ud83c\udf89 Profilin tam! AI asistan\u0131n maksimum g\u00fc\u00e7te \u00e7al\u0131\u015f\u0131yor. Art\u0131k sana \u2018sen i\u00e7in do\u011fru\u2019 olan\u0131 s\u00f6yleyebilirim." },
}
